...
- Publication: any form of (written) communication made available for distribution to the public<br><br>
...
- Author Information
    ...
    - Note that the email address may no longer be valid; you may need to do some digging to find the author's current address
    
## The anatomy of a research article

- *Graphical Abstract*
    - An image that represents the main idea of the paper
    - Often a flow chart or schematic diagram; can be a photo
